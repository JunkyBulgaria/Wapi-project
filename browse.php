        ...
        <div class="container" style="height: auto; padding: -200px;">
            ...
            <div class="form-content">
                ...
                <div class="row" style="padding-top: 70px">
                    ...
                    <?php if($page != 1) {?><div class="content-left" style="width: 350px;padding-top: 45px; padding-left:213px;"><a href="browse.php?page=<?php if($page <= 1) echo "1"; else echo $page-1; ?>"><button type="submit" class="button" style="margin-left: -125px;">Previous <span class="glyphicon glyphicon-book" style="vertical-align:center; align:left;"></span></button></a></div><?php } ?>
